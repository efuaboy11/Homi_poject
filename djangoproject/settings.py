...
SECRET_KEY = "django-insecure-_$vz4acr)i+e62*t^o)0e42tqp&t$trc8rn&n*dzm0-%&2+4c^"
...
SIMPLE_JWT = {
    ...
    "TOKEN_OBTAIN_SERIALIZER": "base.serializers.CustomTokenObtainPairSerializer",  # ✅ fixed
